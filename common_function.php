...
function getnavproducts()
{
    ...
    $select_category="SELECT * FROM product_table ORDER BY RAND() limit 0,4 ";
            ...
            while($row_data=mysqli_fetch_assoc($result_category))
            {
                ...
                <a href='login.php'><img src='3737372.png'  class='cart'></a>
                </div>";
            }
...
function showcartdata(){
    ...
    if($num_of_rows==0){
        echo "<tr><td>Add product to card</td></tr>";
    }else{
    while($row=mysqli_fetch_array($result_bran)){
        ...
        $brand_name=$row_d['brand_title'];
            ...
            $image_path1 = "admin side/product images/$image1";
            echo "<form action='cartform.php' method='post'>
            <tr>
                <td><button type='submit' name='delete_cart' class='btndlt'>x</button></td>
