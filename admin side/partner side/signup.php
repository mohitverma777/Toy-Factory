<?php
   ...
   $query = "SELECT * FROM `partner_table` WHERE `partner_email`= '$email'";
...
if(isset($_POST['signup'])){
    ...
    //insert query
    $request = "INSERT INTO `partner_table`(`partner_email`, `name`,`password`) VALUES ('$emailin','$name','$hash_password')";
