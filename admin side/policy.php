...
<g id="SVGRepo_iconCarrier"> <defs> <style> .cls-1 { fill: none; } </style> </defs> <path d="M29.4819,8.624l-10-5.5a1,1,0,0,0-.9638,0l-10,5.5a1,1,0,0,0,0,1.752L18,15.5913V26.3086l-3.0362-1.6693L14,26.3912l4.5181,2.4848a.9984.9984,0,0,0,.9638,0l10-5.5A1,1,0,0,0,30,22.5V9.5A1,1,0,0,0,29.4819,8.624ZM19,5.1416,26.9248,9.5,19,13.8584,11.0752,9.5Zm9,16.7671-8,4.4V15.5913l8-4.4Z"/> <rect x="2" y="14" width="8" height="2" transform="translate(12 30) rotate(-180)"/> <rect x="4" y="22" width="8" height="2" transform="translate(16 46) rotate(-180)"/> <rect x="6" y="18" width="8" height="2" transform="translate(20 38) rotate(-180)"/> <rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" class="cls-1" width="32" height="32"/> </g>
		...
		<div class="products-area-wrapper tableView">
            <div class="app-content-header">
              <h1 class="app-content-headerText">Privacy Policy</h1>
            </div>
            <div class="acc" id="insertcategories" style="margin-top:5px;">
              <div class="contai"><h3 class="acc-header">Insert New Policy</h3></div>

			  <form method="POST" action="" style='margin-left:40%;'>
		<label for="information_type" style=" color: #FFFFFF;font-size: 12px;font-weight: lighter;">Policy Name:</label><br>
		<input type="text" id="information_type" name="information_type" required><br><br>

		<label for="information_description" style=" color: #FFFFFF;font-size: 12px;font-weight: lighter;">Policy Description:</label><br>
		<textarea id="information_description" name="information_description" rows="5" required></textarea><br><br>

		<input type="submit" value="Submit" name='submit' class="app-content-headerButton">
	</form>
            ...
            <div class="products-header">
              ...
              <div class="product-cell stock">Policy Name</div>
              <div class="product-cell image">Policy Description</div>
...
if (isset($_POST['submit'])) {
    ...
    $informationDescription = $_POST['information_description'];

    // Perform any necessary validation on the submitted data
    
    // Prepare the SQL statement
    $update_qry = "INSERT INTO `privacypolicy` (`information_type`, `information_description`) VALUES ('$informationType', '$informationDescription')";

    // Execute the statement with the submitted data
    
    $req_query=mysqli_query($connection, $update_qry);
