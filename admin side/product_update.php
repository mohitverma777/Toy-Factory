...
<g id="SVGRepo_iconCarrier"> <defs> <style> .cls-1 { fill: none; } </style> </defs> <path d="M29.4819,8.624l-10-5.5a1,1,0,0,0-.9638,0l-10,5.5a1,1,0,0,0,0,1.752L18,15.5913V26.3086l-3.0362-1.6693L14,26.3912l4.5181,2.4848a.9984.9984,0,0,0,.9638,0l10-5.5A1,1,0,0,0,30,22.5V9.5A1,1,0,0,0,29.4819,8.624ZM19,5.1416,26.9248,9.5,19,13.8584,11.0752,9.5Zm9,16.7671-8,4.4V15.5913l8-4.4Z"/> <rect x="2" y="14" width="8" height="2" transform="translate(12 30) rotate(-180)"/> <rect x="4" y="22" width="8" height="2" transform="translate(16 46) rotate(-180)"/> <rect x="6" y="18" width="8" height="2" transform="translate(20 38) rotate(-180)"/> <rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" class="cls-1" width="32" height="32"/> </g>
        ...
        <div class="products-area-wrapper tableView">
            ...
            <div class="acc" id="insertcategories" style="margin-top:5px;">
              <div class="contai"><h3 class="acc-header">Update Products</h3></div>
        ...
        <form action="" method="post" class="book-form">
              ...
              <div class="flex">
                    ...
                    <input type="text" placeholder="Enter title" name="title" required="required" maxlength="100" value="<?php echo"$product_title"; ?>"/>

                    <span style=" color: #FFFFFF;font-size: 12px;font-weight: lighter;">Product Keyword:</span>
                    <input type="text" placeholder="Enter Keyword" name="keyword" required="required" maxlength="250" value="<?php echo"$product_keyword"; ?>" style="margin-right:200px"/>

                    <span style=" color: #FFFFFF;font-size: 12px;font-weight: lighter;">Product Description:</span>
                    <textarea type="textarea" multiline  rows="5" cols="38" placeholder="Enter Descrition" maxlength="2000" name="description" required="required" style="margin-right:400px"><?php echo"$product_description"; ?></textarea>

                    <span style=" color: #FFFFFF;font-size: 12px; font-weight: lighter;">Product stock:</span>
                    <input type="number" placeholder="Enter stock" name="stock" value="<?php echo"$product_stock";?>" maxlength="5" required="required" />
                    
                    <span style=" color: #FFFFFF;font-size: 12px;font-weight: lighter;">Product Price:</span>
                    <input type="text" placeholder="Enter price" name="price" required="required" maxlength="10"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?php echo"$product_price"; ?>"/>
      </div>

      <button type="submit"  name="update_prd">update</button>
...
<?php
  ...
  if(isset($_POST['update_prd'])){
    ...
    $update_qry="UPDATE `product_table` SET `product_title`='$product_title',`product_keyword`='$product_keyword',`product_description`='$product_description',`product_stock`='$product_stock',`product_price`='$product_price' WHERE product_id='$product_id'";
