...
if(isset($_POST['signup'])){
    ...
    //insert query
    $request = "INSERT INTO `admin_table`( `admin_name`, `admin_email`, `admin_password`, `admin_image`) VALUES ('$name','$emailin','$hash_password','$image')";
        ...
        <div class="container" id="container">
            <div class="form-container sign-in-container">
                ...
                <form action="" method="post"  enctype="multipart/form-data" style="display:<?php echo $none2; ?>;padding-top:80px;">
                    <h1>Create Account</h1>
                    <input type="text" placeholder="Name" name="name" required="required"  onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"/>
                    <input type="file" placeholder="Choose-image" name="image" required="required"/>
