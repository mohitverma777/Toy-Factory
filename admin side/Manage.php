...
<g id="SVGRepo_iconCarrier"> <defs> <style> .cls-1 { fill: none; } </style> </defs> <path d="M29.4819,8.624l-10-5.5a1,1,0,0,0-.9638,0l-10,5.5a1,1,0,0,0,0,1.752L18,15.5913V26.3086l-3.0362-1.6693L14,26.3912l4.5181,2.4848a.9984.9984,0,0,0,.9638,0l10-5.5A1,1,0,0,0,30,22.5V9.5A1,1,0,0,0,29.4819,8.624ZM19,5.1416,26.9248,9.5,19,13.8584,11.0752,9.5Zm9,16.7671-8,4.4V15.5913l8-4.4Z"/> <rect x="2" y="14" width="8" height="2" transform="translate(12 30) rotate(-180)"/> <rect x="4" y="22" width="8" height="2" transform="translate(16 46) rotate(-180)"/> <rect x="6" y="18" width="8" height="2" transform="translate(20 38) rotate(-180)"/> <rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" class="cls-1" width="32" height="32"/> </g>
        ...
        <div class="app-content">
            ...
            <div class="acc">
              <div class="contai"><h3 class="acc-header">Manage</h3></div>
                
                <div class="box-container">
                  
                  <div class="box" style="background:none;">
                    <div class="acc" id="insertcharacter" >
                      <form action="character.php" method="post" enctype="multipart/form-data">
                        <input type="text" name="character" placeholder="enter new character" maxlength="30"required>
                        <input type="file" placeholder="Choose-image" name="character-image" required="required"/>
                        <button type="submit" class="button" name="insertcharacter">insert</button>
                      </form>
                    </div>
                  </div>
                  <div class="box" style="background:none;">
                    <div class="acc" id="insertcategories">
                      <form action="category.php" method="post" enctype="multipart/form-data" >
                        <input type="text" name="category" placeholder="enter new category" maxlength="30" required>
                        <button type="submit" class="button" name="insertcategory">insert</button>
                      </form>
                    </div>
                  </div>
                  <div class="box" style="background:none;">
                  <div class="acc" id="insertbrands">
                      <form action="brand.php" method="post" enctype="multipart/form-data">
                        <input type="text" name="brand" placeholder="enter new brand" maxlength="30" required>
                        <input type="file" placeholder="Choose-image" name="brand-image" required="required"/>
                        <button type="submit" class="button" name="insertbrand">insert Brand</button>
                      </form>
                    </div>
                </div>
                </div>
                <div class="box-container" style="color:white;">
                    <div class="box" style="padding-top:2px">
                      <h4 style="font-weigth:300">Characters</h4>
                        <ul type="none" style='padding-left: 0px;margin-left:0px'>
                        <?php getcharacters();?>
                        </ul>
                    </div>
                    
                    <div class="box" style="padding-top:2px">
                    <h4 style="font-weigth:300">Categories</h4>
                      <ul type="none" style='padding-left: 0px;margin-left:0px'>
                      <?php getcategory();?>
                      </ul>
                    </div>
                    <div class="box" style="padding-top:2px">
                    <h4 style="font-weigth:300">Brands</h4>
                      <ul type="none" style='padding-left: 0px;margin-left:0px'>
                      <?php getbrands();?>
                      </ul>
                    </div>
