    ...
    <div class="acc">
        ...
        <div class="ot-box"> 
            <div class="in-boxx width">
                ...
                <div class="inner-box">
                    <strong>New Name:</strong><form action="" method="post" style="height:15px; width:400px">
                <input type="text" id="name" name="email" value="<?php echo "$email";?>" required="required" style="width:200px">
                </div>
                <div class="btn-box1">
...
<?php
    ...
    if(isset($_POST['change_email'])){
        $email=$_POST['email'];
        $update_email="UPDATE `usertb` SET `email`='$email' WHERE email='$user_email'";
        $update_cart="UPDATE `cart_details` SET `user_email`='$email' WHERE user_email='$user_email'";
        mysqli_query($connection,$update_cart);
        unset($_SESSION['user_email']);
        mysqli_query($connection,$update_email);
        
        $_SESSION['user_email']=$email;
        echo "<script>alert('email updated');window.location.href ='yourinfo.php'</script>";
    }else{
