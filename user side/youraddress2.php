...
<div id="navbody">
    ...
    <!-- body start -->
    <div class="acc">
        <div class="h-d"><h2>Your Address</h2></div>
        <div class="ot-box"> 
            <div class="in-boxx width">
            <div class="inner-box">
                <form action="" method="post" >
                <textarea id="name" name="address"  required="required" rows="5" cols="50" ><?php echo $address;?></textarea>
                </div>
                <div class="btn-box1">
                    <button type="submit" name="save_address">Save</button>
                    </form>
                </div>
            </div>
        </div>
...
<?php
    ...
    if(isset($_POST['save_address'])){
        ...
        $update_name="UPDATE `usertb` SET `address`='$address' WHERE email='$email'";
