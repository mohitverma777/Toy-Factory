    ...
    <div class="acc">
        ...
        <div class="ot-box"> 
            <div class="in-boxx width">
                ...
                <div class="inner-box">
                    <strong>New Password:</strong><form action="" method="post" style="height:15px; width:400px">
                <input type="password" id="name" name="password"  required="required" style="width:200px">
                </div>
                <div class="btn-box1">
...
<?php
    ...
    if(isset($_POST['change_name'])){
        ...
        echo "<script>alert('password updated');window.location.href ='yourinfo.php'</script>";
    }else{
